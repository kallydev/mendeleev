...
impl Element {
    ...
    pub const fn oxidation_states(&self, category: OxidationStateCategory) -> &'static [i8] {
        ...
        match (self, category) {
            ...
            (E::Sc, O::All) => &[0, 1, 2, 3],
            (E::Ti, O::Main) => &[4],
            (E::Ti, O::Extended) => &[-2, -1, 0, 1, 2, 3],
            (E::Ti, O::All) => &[-2, -1, 0, 1, 2, 3, 4],
            (E::V, O::Main) => &[5],
            (E::V, O::Extended) => &[-3, -1, 0, 1, 2, 3, 4],
            (E::V, O::All) => &[-3, -1, 0, 1, 2, 3, 4, 5],
            (E::Cr, O::Main) => &[3, 6],
            (E::Cr, O::Extended) => &[-4, -2, -1, 0, 1, 2, 4, 5],
            (E::Cr, O::All) => &[-4, -2, -1, 0, 1, 2, 3, 4, 5, 6],
            (E::Mn, O::Main) => &[2, 4, 7],
            (E::Mn, O::Extended) => &[-3, -1, 0, 1, 3, 5, 6],
            (E::Mn, O::All) => &[-3, -1, 0, 1, 2, 3, 4, 5, 6, 7],
            (E::Fe, O::Main) => &[2, 3],
            ...
            (E::Tc, O::Main) => &[4, 7],
            (E::Tc, O::Extended) => &[-3, -1, 1, 2, 3, 5, 6],
            (E::Tc, O::All) => &[-3, -1, 1, 2, 3, 4, 5, 6, 7],
            (E::Ru, O::Main) => &[3, 4],
            (E::Ru, O::Extended) => &[-4, -2, 1, 2, 5, 6, 7, 8],
            (E::Ru, O::All) => &[-4, -2, 1, 2, 3, 4, 5, 6, 7, 8],
            (E::Rh, O::Main) => &[3],
            (E::Rh, O::Extended) => &[-3, -1, 1, 2, 4, 5, 6, 7],
            (E::Rh, O::All) => &[-3, -1, 1, 2, 3, 4, 5, 6, 7],
            (E::Pd, O::Main) => &[2, 4],
            (E::Pd, O::Extended) => &[1, 3, 5],
            (E::Pd, O::All) => &[1, 2, 3, 4, 5],
            (E::Ag, O::Main) => &[1],
            ...
            (E::Dy, O::Main) => &[3],
            (E::Dy, O::Extended) => &[0, 1, 2, 4],
            (E::Dy, O::All) => &[0, 1, 2, 3, 4],
            (E::Ho, O::Main) => &[3],
            (E::Ho, O::Extended) => &[0, 1, 2],
            (E::Ho, O::All) => &[0, 1, 2, 3],
            (E::Er, O::Main) => &[3],
            (E::Er, O::Extended) => &[0, 1, 2],
            (E::Er, O::All) => &[0, 1, 2, 3],
            (E::Tm, O::Main) => &[3],
            ...
            (E::Rf, O::All) => &[3, 4],
            (E::Db, O::Main) => &[],
            (E::Db, O::Extended) => &[3, 4, 5],
            (E::Db, O::All) => &[3, 4, 5],
            (E::Sg, O::Main) => &[],
            (E::Sg, O::Extended) => &[3, 4, 5, 6],
            (E::Sg, O::All) => &[3, 4, 5, 6],
            (E::Bh, O::Main) => &[],
            (E::Bh, O::Extended) => &[3, 4, 5, 7],
            (E::Bh, O::All) => &[3, 4, 5, 7],
            (E::Hs, O::Main) => &[],
            (E::Hs, O::Extended) => &[3, 4, 6, 8],
            (E::Hs, O::All) => &[3, 4, 6, 8],
            (E::Mt, O::Main) => &[],
            (E::Mt, O::Extended) => &[1, 3, 6],
            (E::Mt, O::All) => &[1, 3, 6],
            (E::Ds, O::Main) => &[],
            (E::Ds, O::Extended) => &[2, 4, 6],
            (E::Ds, O::All) => &[2, 4, 6],
            (E::Rg, O::Main) => &[],
            (E::Rg, O::Extended) => &[-1, 3, 5],
            (E::Rg, O::All) => &[-1, 3, 5],
            (E::Cn, O::Main) => &[],
            (E::Cn, O::Extended) => &[2, 4],
            (E::Cn, O::All) => &[2, 4],
            ...
            (E::Ts, O::All) => &[-1, 5],
            (E::Og, O::Main) => &[],
            (E::Og, O::Extended) => &[-1, 1, 2, 4, 6],
            (E::Og, O::All) => &[-1, 1, 2, 4, 6],
        }
    }
}
